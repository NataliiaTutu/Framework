...
import com.framework.utils.CucumberLogUtils;
...
public class CommonUtils extends WebDriverUtils {
    ...
    /***
     * Use this overloaded method to scroll into view by passing the locator of an
     * element
     * 
     * @param locator
     */
    ...
    /**
     * Use this method to take screenshots with CucumberLogUtils when doing
     * non-mobile testing
